...
public class OrderBean
{
   ...
   {
      OrderItems clientOrderItems = new OrderItems();
      String response = clientOrderItems.get_application_json(String.class, oucu, password);
   ...
   {
       Orders clientOrders = new Orders();
      return    clientOrders.post_application_x_www_form_urlencoded(String.class, oucu, password, this.getClientId(), this.getLatitude(), this.getLongitude());
   }
   ...
   {
       OrderItems clientOrderItems = new OrderItems();       
      return clientOrderItems.post_application_x_www_form_urlencoded(String.class, oucu, password, this.getOrderId(), this.getWidgetId(), this.getNumber(), this.getPence());
   }
