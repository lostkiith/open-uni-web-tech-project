...
public class Utilities
{
   ...
   public static String prettyOrderItems(JsonArray oderItems)
   {
        StringBuilder temp = new StringBuilder("<table>");
        ...
        temp.append(String.format(header, "id", "order_id", "widget_id", "number", "pence_price"));
        
         System.out.println(temp.toString());

      for (int i = 0; i < oderItems.size(); i++)
      {
         JsonObject jo = (JsonObject) oderItems.get(i);
